            ...
            if inp = 0wx60
              ...
              then if inp = 0wx3A
                  ...
                  then if inp = 0wx28
                      ...
                      then yyAction11(strm, yyNO_MATCH)
                      else yyQ13(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                else if inp = 0wx5B
                  then yyAction11(strm, yyNO_MATCH)
                else if inp < 0wx5B
                  then if inp <= 0wx40
        ...
        | SOME(inp, strm') =>
            if inp = 0wx61
              ...
              then if inp = 0wx6F
                  ...
                  then if inp = 0wx6E
                      then yyQ22(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                      else yyQ13(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                else if inp = 0wx7B
                  then yyAction11(strm, yyNO_MATCH)
                else if inp < 0wx7B
            ...
            if inp = 0wx60
              ...
              then if inp = 0wx3A
                  ...
                  then if inp = 0wx28
                      ...
                      then yyAction10(strm, yyNO_MATCH)
                      else yyQ13(strm', yyMATCH(strm, yyAction10, yyNO_MATCH))
                else if inp = 0wx5B
                  then yyAction10(strm, yyNO_MATCH)
                else if inp < 0wx5B
                  then if inp <= 0wx40
        ...
        | SOME(inp, strm') =>
            if inp = 0wx61
              ...
              then if inp = 0wx67
                  ...
                  then if inp = 0wx66
                      then yyQ23(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                      else yyQ13(strm', yyMATCH(strm, yyAction11, yyNO_MATCH))
                else if inp = 0wx7B
                  then yyAction11(strm, yyNO_MATCH)
                else if inp < 0wx7B
...
fun yyQ5 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction15(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wxD
              then yyQ5(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
            else if inp < 0wxD
              then if inp = 0wx9
                  then yyQ5(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
                else if inp < 0wx9
...
fun yyQ4 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction16(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx5C
              then yyQ4(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
              else yyQ2(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
      (* end case *))
and yyQ2 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction16(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx23
              then yyQ2(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
            else if inp < 0wx23
              then if inp = 0wx22
       ...
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = 0wx23
              ...
              then if inp = 0wx22
                  then yyQ3(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                  else yyQ2(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
            else if inp = 0wx5C
              then yyQ4(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
              else yyQ2(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
